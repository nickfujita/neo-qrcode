...
function qrImg(nep9Data, imgEle, theme) {
    generateDataUrl(nep9Data, null, theme === 'neo' && neo_colors)
        .then(uri => {
        imgEle.src = uri;
    });
}
function generateString(nep9Data, type = 'svg', color) {
    const uri = _nep9__WEBPACK_IMPORTED_MODULE_0__["default"].generateUri(nep9Data);
    const options = {
        type,
        color,
